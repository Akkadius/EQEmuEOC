<?php
	...
	function GetProximityContent($taskid, $activityid, $newentry)
	{
		...
		$Query = "SELECT proximities.exploreid, proximities.zoneid, proximities.minx, proximities.maxx, proximities.miny, proximities.maxy, proximities.minz, proximities.maxz, 
						activities.taskid, activities.activityid, activities.goalid, activities.goalmethod, activities.activitytype FROM proximities, activities 
						WHERE proximities.exploreid = activities.goalid AND activities.goalmethod = 0 AND activities.activitytype = 5 
