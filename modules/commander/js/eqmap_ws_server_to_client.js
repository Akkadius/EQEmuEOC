    ...
    if (json.id == 'get_initial_entity_positions') {
        if(json.type == "Door" || json.type == "Object"){
            ...
            if(json.type == 'NPC'){
                ...
                aggro_bubble = '<i class="fa fa-circle-thin" style="position:absolute;pointer-events:none;top:-' + circle_offset_top + 'px;left:-' + circle_offset_left + 'px;font-size:' + round(aggro_radius * 2.4, 0) + 'px;color:red !important;opacity:.3"></i>';
                ...
                //aggro_bubble += '<circle cx="' + left + '" cy="' + top + '" r="' + (aggro_radius / 13) + '" fill="none" stroke="#f00" stroke-width="0.08"/></svg>';
            }
        }
