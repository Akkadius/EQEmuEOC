<?php 
	...
	<div class="top-menu">
		<ul class="nav navbar-nav pull-right">
			...
			echo '<li class="dropdown dropdown-user" >
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
				<span class="username" style="height:30px;padding-top:5px"> <i class="fa fa-circle-o-notch" style="font-size:20px;text-shadow: 0px 0px 20px #FCFF9B;color: #ffffff;"></i> Menu</span>
				<i class="fa fa-angle-down"></i>
				</a>
				<ul class="dropdown-menu">
					<li>
						<a href="login.php">
						<i class="icon-key"></i> Login Page </a>
					</li>
				</ul>
			</li>';
			*/
	...
	echo '<!-- END QUICK SIDEBAR TOGGLER -->
		</ul>
	</div>
